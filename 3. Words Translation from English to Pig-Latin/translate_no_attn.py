"""Script to visualize attention maps using a pre-trained model.
    ...
    Usage: python translate_no_attn.py --load=checkpoints/no-attn/py3
"""
...
def create_parser():
    ...
    parser.add_argument('--load', type=str, default='checkpoints/no-attn/py3', help='Path to checkpoint directory.')
