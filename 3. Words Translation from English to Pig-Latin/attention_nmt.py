...
def main(opts):
    ...
    ##############
    # # My code for test, no attention decoder
    # opts.no_attention = True
    ############
    #############
    # My code for test, attention decoder
    opts.no_attention = False
    ###########
...
def create_parser():
    """Creates a parser.forward for command-line arguments.
    """
